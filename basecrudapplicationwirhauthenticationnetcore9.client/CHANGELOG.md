...
- Create Angular project with ng: `ng new basecrudapplicationwirhauthenticationnetcore9.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`basecrudapplicationwirhauthenticationnetcore9.client.esproj`).
